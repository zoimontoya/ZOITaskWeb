...
echo "   - Localmente: http://localhost:8090"
echo "   - Desde otros dispositivos en tu red: http://$LOCAL_IP:8090"
echo ""
echo "🔧 Backend API disponible en:"
echo "   - Localmente: http://localhost:3000/health"
echo "   - Desde otros dispositivos: http://$LOCAL_IP:3000/health"
echo ""
echo "📱 Comparte la URL http://$LOCAL_IP:8090 con otros dispositivos en tu WiFi"
echo ""
